...
```bash
git clone https://github.com/kusupriyanka04/Healthy-Habits-Backend.git
...
|---|---|---|
| ![Dashboard](./screenshots/dashboard.png) | ![Analytics](./screenshots/analytics.png) | ![Challenges](./screenshots/challenges.png) |
